...
Python package to use MRC Systems [Active Laser Beam Stabilization][https://www.mrc-systems.de/en/products/laser-beam-stabilization] with python. The communication protocol is based on version [JH - 24.05.2023][https://www.mrc-systems.de/downloads/de/laser-strahlstabilisierung/BA-digital-communication-interface_ver8_2.pdf].
